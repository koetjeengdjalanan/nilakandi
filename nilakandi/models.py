...
class ExportReport(models.Model):
    ...
    resource_group = models.CharField(null=True)
    ...
    meter_sub_category = models.CharField(null=True)
    meter_id = models.CharField(null=False)
    meter_name = models.CharField(null=False)
    meter_region = models.CharField(null=True)
    ...
    cost_center = models.CharField(null=True)
    consumed_service = models.CharField(null=True)
    resource_id = models.CharField(null=True)
    tags = models.CharField(null=True)
    offer_id = models.CharField(null=True)
    additional_info = models.JSONField(default=dict, null=True)
    service_info_1 = models.CharField(null=True)
    service_info_2 = models.CharField(null=True)
    resource_name = models.CharField(null=True)
    reservation_id = models.CharField(null=True)
    reservation_name = models.CharField(null=True)
    unit_price = models.FloatField(null=False)
    product_order_id = models.CharField(null=True)
    product_order_name = models.CharField(null=True)
    term = models.CharField(null=True)
    publisher_type = models.CharField(null=False)
    publisher_name = models.CharField(null=False)
    charge_type = models.CharField(null=False)
    frequency = models.CharField(null=False)
    pricing_model = models.CharField(null=False)
    availability_zone = models.CharField(null=True)
    ...
    plan_name = models.CharField(null=False)
    service_family = models.CharField(null=False)
    cost_allocation_rule_name = models.CharField(null=True)
    benefit_id = models.CharField(null=True)
    benefit_name = models.CharField(null=True)
    resource_location_normalized = models.CharField(null=True)
