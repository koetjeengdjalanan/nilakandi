...
class VirtualMachine(models.Model):
    ...
    pic_owner = models.CharField(max_length=64)
    application_name = models.CharField(max_length=128)
    hostname = models.CharField(max_length=64)
    os_platform = models.CharField(max_length=64)
    owner = models.CharField(max_length=64)
    marvel_project = models.CharField(max_length=128)
    marvel_workstream = models.CharField(max_length=128)
    monitor_status = models.BooleanField()
